...
public class PointOfSales extends Application {
     ...
     *
     * The main() serves only as a fallback in case the application can not be
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            window.getIcons().add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/POS-icon.png")));
        ...
        try {
            welcomeImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/welcomeLabel.png"));
            ...
            Welcome.setStyle(
                    "-fx-background-position: center; -fx-background-repeat: no-repeat; -fx-background-size: cover, auto;");
        ...
        /* Images */
        Image buyImg, addImg, removeImg, sortImg, exitImg;
        ...
        try {
            buyImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/buy.png"));

            addImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/add.png"));
            removeImg = new Image(
                    new FileInputStream("src/main/java/com/pointofsales/Image/removeProd.png"));
            sortImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/sortProd.png"));
            ...
            /* Exit Image */
            exitImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/exit.png"));
        ...
        middleMenu.getChildren().addAll(Welcome, header, buyProducts, addProducts, removeProducts, searchProducts,
                sortProducts, hbox);
     ...
     *
     * The cells values of each columns must be equal to the instance variables of
     * the Products.java constructor.
     */
    private void tableList() {
        ...
        getProducts();
        table.getColumns().addAll(nameColumn, productIDColumn, priceColumn, weightColumn, caloriesColumn,
                quantityColumn, categoryColumn);
    }

    /**
     * CloseProgram() is used with with ConfirmBox.java to give confirmation when
     * close the window.
     *
     * Platform.exit is used to exit the whole application since window is the main
     * stage.
     *
    ...
    private void closeBuyWindow() {
        ...
        if (answer) {
            /**
             * Deletes the Cart.txt & totalPrice.txt which is used to save customer's
             * orders.
             *
            ...
            window.close();
            /**
             * Platform.runLater() is used to restart the application so that the table on
    ...
    private void MenuItems(Menu fileMenu, Menu editMenu, Menu optionsMenu, Menu helpMenu) {
        ...
        About.setOnAction(e -> {
            ...
            try {
                POSimage = new Image(
                        new FileInputStream("src/main/java/com/pointofsales/Image/POS-icon.png"));
                ...
                alert.setHeaderText(
                        "This Point Of Sale System(POS) is the time and place where a retail transaction is completed. "
    ...
    private int count() {
        ...
        try {
            /* Reads file. */
            File inputFile = new File("src/main/java/com/pointofsales/Products.txt");
    ...
    /**
     * buyProduct() method is used to buy products by selecting the products from
     * the table.
     *
     * The amount of the product bought is added and finally the total price is
     * calculated.
     */
    private void buyProduct() {
        ...
        try {
            buyWindow.getIcons()
                    .add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/buy.png")));
        } catch (FileNotFoundException e1) {
            e1.printStackTrace();
        }
            ...
            if (e.getClickCount() > 1) {
                if (table.getSelectionModel().getSelectedItem() != null) {
                    try {
                        ...
                        /**
                         * .initModality(Modality.APPLICATION_MODAL) blocks actions on the other windows
        ...
        Image cart, backImg;
        try {
            cart = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/cartButton.png"));

            backImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/back.png"));
            ...
            leftLayout.getChildren().addAll(topLayout, buyNameField, buyIDField, buyAmountField, buyPriceField,
                    cartButton,
                    backButton);
    ...
    /**
     * calculatePrice() method calculates the total price * the amount bought by
     * user.
     *
    ...
    /**
     * viewCart() enables the user to view the products bought, the total price and
     * to finish buying.
     */
    private void viewCart() {
        ...
        try {
             ...
             *
             * It will loop through the file until no more String is found and returns
             * false.
             */
            ...
            /* Image */
            Image continueImg = new Image(
                    new FileInputStream("src/main/java/com/pointofsales/Image/continue.png"));
    ...
    private void continueBuy(final double totalSum, final String formatSum) {
        try {
            ...
            if (!result.isPresent() || !result.get().matches("^[0-9.]+$")) {
                ...
                /* Image */
                Image okImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/ok.png"));
     ...
     */
    private void viewReceipt(final String change_money, final String total_Price, final String money_Of_Customer,
            final String prod) {
    ...
    private void addProduct() {
        ...
        try {
            addWindow.getIcons()
                    .add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/add.png")));
        } catch (FileNotFoundException e1) {
            e1.printStackTrace();
        }
        ...
        categoryChoice.getItems().addAll("Dairy", "Egg", "Poultry", "Meat", "Fish", "Vegetables", "Snacks", "Grain",
                "Cereal", "Sweets",
        ...
        try {
            ...
            hbox.setSpacing(25);
            hbox.getChildren().addAll(nameInput, productIDInput, priceInput, weightInput, caloriesInput, quantityInput,
                    categoryChoice, addButton, backButton);
    ...
    public void add() {
        ...
        try {
            ...
            bw.write(nameInput.getText() + " " + Integer.parseInt(productIDInput.getText()) + " "
             ...
             *
             * If countName/countID > 1, then the product already exists and cannot be
             * added.
             */
            for (int i = 0; i < count(); i++) {
    ...
    private void removeProduct() {
        ...
        try {
            removeWindow.getIcons()
                    .add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/removeProd.png")));
        } catch (FileNotFoundException e1) {
            e1.printStackTrace();
        }
        ...
        /* Image */
        Image removeImg, backImg;
        try {
            removeImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/remove.png"));
            backImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/back.png"));
     ...
     *
     * The File is then re written without the ID entered and all its
     * informations.(Name, weight, calories, category, etc...)
     */
    public void remove() {
        ...
        try {
            ...
            File inputFile = new File("src/main/java/com/pointofsales/Products.txt");
            try (PrintStream writer = new PrintStream(inputFile)) {
     ...
     *
     * Then if x is equal to searchResult, the iteration will increase by 1 in
     * anotherProducts[k++].
     *
    ...
    private void searchProductName() {
        ...
        try {
            searchWindow.getIcons()
                    .add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/searchProd.png")));
        } catch (FileNotFoundException e1) {
            e1.printStackTrace();
        }
        ...
        /* Images */
        Image searchImg, backImg;
        try {
            searchImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/search.png"));
            backImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/back.png"));
    ...
    public void sortProduct() {
        ...
        try {
            sortWindow.getIcons()
                    .add(new Image(new FileInputStream("src/main/java/com/pointofsales/Image/sortProd.png")));
        } catch (FileNotFoundException e1) {
            e1.printStackTrace();
        }
        ...
        /* Images */
        Image sortImg, sortIDImg, sortSmallPriceImg, sortLargePriceImg, resetImg, backImg;
        try {
            sortImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/sortName.png"));
            sortIDImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/sortID.png"));
            sortSmallPriceImg = new Image(
                    new FileInputStream("src/main/java/com/pointofsales/Image/sortSmallestPrice.png"));
            sortLargePriceImg = new Image(
                    new FileInputStream("src/main/java/com/pointofsales/Image/sortLargestPrice.png"));
            resetImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/reset.png"));
            backImg = new Image(new FileInputStream("src/main/java/com/pointofsales/Image/back.png"));
